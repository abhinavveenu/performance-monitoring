...
export class ErrorRepository {
  ...
  static async insert(
    ...
    try {
      ...
      console.error(`Error inserting error record for page ${error.page_id}:`, err);
      throw new Error(`Failed to insert error record: ${err instanceof Error ? err.message : 'Unknown error'}`);
    }
  }
}
